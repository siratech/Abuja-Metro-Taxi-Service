<?php
	...
	{	
	$location = $_POST['latitude'].", ".$_POST['logitude'];
	...
	mysqli_query($conn,"insert into trips (`userid`, `distination`, `location`, `location_long`, `at_time`, `driverid`)
	values ('$userid','$destination','$location','$locat','$tripat','$driver')");
...
<div id="map">
        ...
        <a href="menu.php" class="btn btn-success btn-lg btn-block"><span class="fa fa-car"></span> Ok</a>
